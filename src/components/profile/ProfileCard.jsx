...
export default function ProfileCard({ userProfile, onEditClick }) {
  ...
  return (
    <div className="bg-white rounded-3xl p-4 shadow-sm border border-slate-200 relative mb-2.5 space-y-2.5">
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-3 min-w-0 flex-1">
          <div className="w-14 h-14 bg-slate-100 rounded-2xl overflow-hidden border border-slate-200 flex items-center justify-center shrink-0 shadow-inner">
            {avatar ? (
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          {username && (
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="w-8 h-8 bg-blue-50 hover:bg-blue-100 text-blue-600 rounded-xl flex items-center justify-center transition-all border border-blue-200/60 shadow-inner"
              title="Telegram"
            >
          ...
          {instagramUser && (
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="w-8 h-8 bg-pink-50 hover:bg-pink-100 text-pink-600 rounded-xl flex items-center justify-center transition-all border border-pink-200/60 shadow-inner"
              title="Instagram"
            >
          ...
          <button 
            onClick={onEditClick}
            className="w-8 h-8 rounded-xl bg-slate-50 hover:bg-slate-100 flex items-center justify-center text-slate-600 transition-colors border border-slate-200 shadow-inner"
