...
import { Calendar, Clock, Plus, Trash2, CheckCircle2, MapPin } from 'lucide-react';
...
export default function ScheduleTab({ trainerProfile, onUpdate }) {
  ...
  // Инициализируем расписание из профиля тренера или создаем пустое
  ...
  const handleSaveSchedule = async () => {
    ...
    if (error) {
      ...
      alert('График работы в зале успешно сохранен! Теперь ученики увидят ваши смены.');
        ...
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-500">Укажите дни, время смен и тип занятий, чтобы ученики знали, когда вы в клубе</p>
            </div>
          </div>
        </div>
