...
export default function GymBroTab() {
  ...
  return (
    <div className={`min-h-screen bg-[${appleTheme.colors.bg}] text-[${appleTheme.colors.primaryText}] px-4 pt-3 pb-20 flex flex-col max-w-md mx-auto ${appleTheme.styles.fontFamily}`}>
      ...
      {/* Основной экран свайпов: возраст перенесен наверх к тегу */}
      {activeSubTab === 'swipe' && currentProfile && (
        <div className="flex-1 flex flex-col justify-center space-y-2.5 my-auto animate-fadeIn pb-1">
          ...
          <div className="bg-white rounded-[26px] shadow-[0_8px_28px_rgba(0,0,0,0.05)] border border-black/[0.05] overflow-hidden relative flex flex-col mx-auto w-full max-w-[370px]">
            <div className="relative w-full aspect-[4/3.8] bg-zinc-900">
              ...
              {/* Тег статуса и возраст рядом вверху */}
              ...
              {/* Имя крупно без возраста снизу */}
              <div className="absolute bottom-3 left-3.5 right-3.5 text-white">
                <h2 className="text-[26px] font-bold tracking-tight">{currentProfile.name}</h2>
                <div className="text-[11.5px] text-blue-300 font-medium mt-0.5 flex items-center gap-1">
          ...
          {/* Панель кнопок свайпов */}
          <div className="bg-white/90 backdrop-blur-xl border border-black/[0.06] rounded-[22px] px-6 py-2.5 shadow-[0_4px_18px_rgba(0,0,0,0.05)] flex items-center justify-between mx-auto w-full max-w-[370px]">
