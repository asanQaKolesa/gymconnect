...
export default function HomeHeader({ onOpenSub, onOpenNotif }) {
  return (
    <div className="mb-3">
      ...
      <div className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-50 rounded-xl border border-slate-100 text-[11px] text-slate-500">
        <Zap className="w-3.5 h-3.5 text-amber-500 fill-amber-500 shrink-0" />
        <span>Уже <strong>30+ атлетов</strong> тренируются с нами в Алматы</span>
      </div>
    </div>
  );
}
