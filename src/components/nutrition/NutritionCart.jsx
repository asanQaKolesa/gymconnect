...
export default function NutritionCart() {
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-100 mb-4 overflow-hidden">
      ...
      <button 
        onClick={() => alert('Открытие продуктовой корзины')}
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-sm font-medium text-slate-900">Продуктовая корзина</div>
            <div className="text-xs text-slate-400">Список продуктов на неделю для заказа</div>
          </div>
        </div>
